<?php
    ...
    if((sizeof($cases)==19 and $offers==0) or (sizeof($cases)==14 and $offers==1) or (sizeof($cases)==10 and $offers==2) or (sizeof($cases)==7 and $offers==3) or (sizeof($cases)==5 and $offers==4) or (sizeof($cases)==4 and $offers==5) or (sizeof($cases)==3) and $offers==6 or (sizeof($cases)==2 and $offers==7))
    {
        header("Location: gameOffer.php");
    }
    if(sizeof($cases)==1)
    {
        header("Location: gameSwitch.php");
    }
?>
<!DOCTYPE html>
